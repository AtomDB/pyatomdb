...
# here the first number is the atomic number, second number is the temperature in K

d=class_apec.element(26, 40000000, 1, 0, 1.0, 'None', Abund)
ionfrac =  d.calc_elem_ionbal_delta(26, 40000000, 1.0, 'None')


# Decreasing the einstein A's and collision rates between the levels [2,5],[1,1] by 20 %, ionization rates can be changed with the keyword 'IR'

a=class_apec.variableapec(26,25,10000000,1,[2,5],[1,1],[[0.8,0.8],[0.8,0.8]],['LA','EC'],[2,5],[1,1],0,Abund,settings,ionfrac)


# reporting the changed emissivities for levels [2,5],[1,1]
