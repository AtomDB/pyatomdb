...
#PHYSICAL CONSTANTS
KBOLTZ_OLD = 8.617385e-8#  /*!< in units of keV/K *== 1/(11604.5*1000)/
KBOLTZ = 8.617333262e-8#  in units of keV/K  (CODATA 2022)
M_E = 2.7182818284590452354 # /*!< Euler e */

UPSILON_COLL_COEFF = 8.629e-6 # /*!< sqrt{2 pi / kB} hbar^2/m_e^{1.5} */
ERG_KEV = 1.602176634e-9 # erg/keV (CODATA 2022)
ERG_KEV_OLD = 1.60219e-9
ME_KEV = 510.99895069 #keV (CODATA 2022)
...
AMUKG = 1.66053906892e-27 #kg (CODATA 2022)
AMUKG_OLD = 1.66054E-27
...
CI_YOUNGER         = 51
CI_URDAMPILLETA    = 52
CI_HAHNMULLERSAVIN = 53 # Double ionization rate coeffts
